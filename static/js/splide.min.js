...
function S(n, t) {
    return n = n ? o(n.children) : [], t ? n.filter(function(n) {
        return cn(n, t)
    }) : n
}
...
function j(n, t, i) {
    return n = document.createElement(n), t && (C(t) ? M : I)(n, t), i && L(i, n), n
}

function _(n, t, i) {
    return en(i) ? getComputedStyle(n)[t] : void(c(i) || (n.style[t] = "" + i))
}
